...
namespace PacMan
{
    class Ghost
    {
        ...
        public Ghost(int x, int y, ImageList imglist, Board board, Form1 form)
        {
            this.form = form;
            this.board = board;
        ...
        private void timer_Tick(object sender, EventArgs e)
        {
            ...
            MoveGhosts();
            form.sendForInky(checkX, checkY);
        ...
        public void MoveGhosts()
        {
            ...
            if (blinkyMoveRouteX.Count != 0 && gX % 2 == 0 && gY % 2 == 0)
            {
                if(checkX == (int)blinkyMoveRouteX[0])
                {
                    if ((int)blinkyMoveRouteY[0] - checkY < 0)
                        Direction = 1;
                    else
                        Direction = 3;
                }
                ...
                {
                    if ((int)blinkyMoveRouteX[0] - checkX < 0)
                        Direction = 4;
                    else
                        Direction = 2;
                }
                blinkyMoveRouteX.RemoveAt(0);
                blinkyMoveRouteY.RemoveAt(0);
            }
